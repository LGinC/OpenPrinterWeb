  ...
  load(pdfDocument) {
    ...
    firstPagePromise.then(pdfPage => {
      ...
      Promise.all([_ui_utils.animationStarted, storedPromise, pageLayoutPromise, pageModePromise, openActionPromise]).then(async ([timeStamp, stored, pageLayout, pageMode, openAction]) => {
        ...
        const rotationParam = (0, _ui_utils.parseQueryString)(window.location.hash.substring(1)).get("rotation");
        if (rotationParam !== null) {
          const parsedRotation = parseInt(rotationParam, 10);
          if ((0, _ui_utils.isValidRotation)(parsedRotation)) {
